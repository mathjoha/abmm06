...
Denna lektion behandlar två centrala statistiska metoder för att analysera
samband mellan variabler: korrelation och regression. Vi går igenom
beräkningar, tolkning och inferentiell statistik.
...
Regression används för att förutsäga värdet på en beroende variabel (Y) baserat
på en oberoende variabel (X).
...
Detta betyder att för varje extra timme studietid förväntas resultatet öka med
4.5 procentenheter.

## Residualer (fel)

Residualen är skillnaden mellan det observerade värdet och det värde som
regressionen förutsäger:
...
- Om p < 0.05 förkastar vi nollhypotesen och säger att korrelationen är
